...
public class Robot extends IterativeRobot {
    ...
    public void robotInit() {
        ...
        // TODO: Subsystems and OI should be converted to non-static
        // variables and accessed through getter methods
        gearSubSys = new GearSubsystem();
        driveSubSys = new DrivetrainSubsystem();
        climbSubSys = new ClimberSubsystem();
        oi = new OI();

        this.chooser.addDefault("Default Auto", new EmptyCommand());
        this.chooser.addObject("Drive 50 inches", new DriveDistanceCommand(50, 50));
